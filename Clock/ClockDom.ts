  ...
  generateContent(hours = 0, minutes = 0, secondes = 0) {
    let html = `
      ...
      <svg width="200" height="200" viewBox="0 0 200 200" id="clock">
        ...
        <path id="seconde_hand" data-selectable="yes" d="M 100 100 l 0 -75" stroke="black" stroke-width="2" transform="rotate(0, 100, 100)" />
        <path id="minute_hand" data-selectable="yes" d="M 100 100 l 0 -75" stroke="black" stroke-width="4" transform="rotate(0, 100, 100)" />
